...
exon4_tree <- read.nexus("exon4/exon4.nex")
  plot(exon4_tree, show.tip.label = TRUE, cex=0.4, edge.width = 2)
exon6_tree <- read.nexus("exon6/exon6.nex")
  plot(exon6_tree)
exon9_tree <- read.nexus("exon9/exon9.nex")
  plot(exon9_tree)
...
phylo <- plot.phylo(dscam1_fam, type="fan", cex = 0.8, edge.width = 2)
